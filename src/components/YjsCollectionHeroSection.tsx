// src/components/YjsCollectionHeroSection.tsx
'use client';
...
// Используем SVG вместо PNG
const YJSProfileSVG = () => (
  <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect width="60" height="60" fill="url(#gradient)"/>
    <text x="30" y="38" textAnchor="middle" fill="white" fontSize="20" fontWeight="bold" fontFamily="monospace">YJ</text>
    <defs>
...
const XIcon = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 24C18.6274 24 24 18.6274 24 12C24 5.37258 18.6274 0 12 0C5.37258 0 0 5.37258 0 12C0 18.6274 5.37258 24 12 24Z" fill="#080404"/>
    <path fillRule="evenodd" clipRule="evenodd" d="M4 11.0954L8.8028 6.31738H15.1973L20 11.0954L12 19.0542L4 11.0954ZM8.5793 9.42028C10.4685 7.52868 13.5315 7.52868 15.4207 9.42028L17.0527 11.0542L15.4207 12.6882C13.5315 14.5798 10.4685 14.5798 8.5793 12.6882L6.9474 11.0542L8.5793 9.42028Z" fill="#0CE465"/>
    <path fillRule="evenodd" clipRule="evenodd" d="M10 11.1075C10 12.1831 10.8954 13.0549 12 13.0549C13.1046 13.0549 14 12.1831 14 11.1075C14 10.032 13.1046 9.16016 12 9.16016C10.8954 9.16016 10 10.032 10 11.1075ZM11.1577 11.055C11.1577 11.5202 11.535 11.8971 11.9998 11.8971C12.4647 11.8971 12.842 11.5202 12.842 11.055C12.842 10.5897 12.4647 10.2129 11.9998 10.2129C11.535 10.2129 11.1577 10.5897 11.1577 11.055Z" fill="white"/>
  </svg>
);
...
const DiscordIcon = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clipPath="url(#clip0_4313_515698)">
      ...
      <path d="M18.9247 6.69799C17.5883 5.3923 15.7604 4.58755 13.7443 4.58755C9.65028 4.58755 6.33134 7.90629 6.33134 12.0005C6.33134 16.0946 9.65028 19.4136 13.7443 19.4136C15.7603 19.4136 17.5883 18.6086 18.9247 17.3029C17.3308 19.3815 14.8219 20.7216 12.0002 20.7216C7.1835 20.7216 3.27881 16.8171 3.27881 12.0005C3.27881 7.18379 7.1835 3.2793 12.0002 3.2793C14.8219 3.2793 17.3308 4.61943 18.9247 6.69799Z" fill="url(#paint0_linear_4313_515698)"/>
      <path d="M8.20459 16.2423C9.27378 17.2869 10.7361 17.9307 12.3489 17.9307C15.6244 17.9307 18.2795 15.2758 18.2795 12.0003C18.2795 8.72507 15.6244 6.07 12.3489 6.07C10.7361 6.07 9.27378 6.7138 8.20459 7.7584C9.47979 6.09558 11.4869 5.02344 13.7444 5.02344C17.5977 5.02344 20.7213 8.14699 20.7213 12.0003C20.7213 15.8537 17.5977 18.9772 13.7444 18.9772C11.4869 18.9772 9.47979 17.9051 8.20459 16.2423Z" fill="url(#paint1_linear_4313_515698)"/>
      <path fillRule="evenodd" clipRule="evenodd" d="M12 6.76795C14.89 6.76795 17.2328 9.11077 17.2328 12.0006C17.2328 14.8906 14.89 17.2334 12 17.2334C9.11015 17.2334 6.76733 14.8906 6.76733 12.0006C6.76733 9.11077 9.11015 6.76795 12 6.76795ZM12 8.51223C13.9266 8.51223 15.4885 10.0741 15.4885 12.0006C15.4885 13.9272 13.9266 15.4891 12 15.4891C10.0733 15.4891 8.51161 13.9272 8.51161 12.0006C8.51161 10.0741 10.0733 8.51223 12 8.51223Z" fill="url(#paint2_linear_4313_515698)"/>
    </g>
    <defs>
      <linearGradient id="paint0_linear_4313_515698" x1="18.9247" y1="12.0005" x2="2.58021" y2="12.0005" gradientUnits="userSpaceOnUse">
        <stop stopColor="#5334C1"/>
        <stop offset="1" stopColor="#0BDFF6"/>
      </linearGradient>
      <linearGradient id="paint1_linear_4313_515698" x1="20.7212" y1="12.0004" x2="7.64571" y2="12.0004" gradientUnits="userSpaceOnUse">
        <stop stopColor="#5334C1"/>
        <stop offset="1" stopColor="#0BDFF6"/>
      </linearGradient>
      <linearGradient id="paint2_linear_4313_515698" x1="20.9998" y1="12.0005" x2="2.99976" y2="12.0005" gradientUnits="userSpaceOnUse">
        <stop stopColor="#5334C1"/>
        <stop offset="1" stopColor="#0BDFF6"/>
      </linearGradient>
...
// Адрес вашего контракта после деплоя
